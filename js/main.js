...
document.getElementById('calcola').addEventListener('click',
    ...
    function () {
        ...
        if (nomeUtente == '' || nomeUtente.lenght < 5) {
            document.getElementById('risultato').innerHTML = `E' necessario inserire un nome.`;
        }
        ...
        // SE SONO NUMERI E UN NOME PASSEGGERO E' PRESENTE PROSEGUI 
        else {
